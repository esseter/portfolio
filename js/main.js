jQuery(document).ready(function () {
    ...
    var grid = jQuery('.grid').imagesLoaded(function () {
        ...
        //Fix for background item text
        jQuery('.background-text-holder').each(function () {
            jQuery(this).find('.background-text-wrapper').css('margin-top', (jQuery(this).height() - jQuery(this).find('.background-text-wrapper').height()) / 2 - 70);
        });

        //Fix for background hover text fade in/out
        jQuery('.grid-item a').hover(function () {
            jQuery(this).find('.background-text-holder').fadeIn('fast');
        }, function () {
            jQuery(this).find('.background-text-holder').fadeOut('fast');
        });
    });
...
jQuery(window).load(function () {
    ...
    jQuery('.doc-loader').delay( 2000 ).fadeOut(1000);
});
